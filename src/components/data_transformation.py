...
class  DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            num_pipeline = Pipeline(
                steps=[
                    ('imputer',SimpleImputer(strategy='median')),  #Ton handle the missing values
            ...
            cat_pipeline = Pipeline(    
                steps=[
                    ...
                    ('scaler',StandardScaler(with_mean=False))  # StandardScaler with with_mean=False for sparse matrix
                ]
            )
            ...
            preprocessor = ColumnTransformer(
                transformers=[
                    ('numrical', num_pipeline, numerical_features),
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            train_arr = np.c_[input_feature_train_arr, np.array(target_feature_train_df)]  # Combining input features and target variable
